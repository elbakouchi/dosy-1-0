package com.inspitech.dosy.views.adresseslivraison;

import com.inspitech.dosy.data.entity.SampleAddress;
import com.inspitech.dosy.data.service.SampleAddressService;
import com.inspitech.dosy.views.MainLayout;
...
@PageTitle("Adresses Livraison")
@Route(value = "shipping-address", layout = MainLayout.class)
public class AdressesLivraisonView extends Div {
    ...
    public AdressesLivraisonView(SampleAddressService addressService) {
        addClassName("adresses-livraison-view");
